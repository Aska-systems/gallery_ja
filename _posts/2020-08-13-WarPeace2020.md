...
layout: post
title:  "戦争と平和 2020"
img: war_and_peace2020/war_and_peace2020.png
---
...
<img src="{{site.baseurl}}/images/war_and_peace2020/edge_bundling_Q1.jpg" alt="WarPeace2020_bipartiteQ1"
style = "
  width: 600px;
  border: none;
  background: none;
...
<div class="card">
  ...
  <ul class="list-group list-group-flush">
	...
	<li class="list-group-item">
		政権が、行政や司法を人事で支配する日本は、政府の構造自体が戦争の原因になっている。特に司法の任務放棄が深刻。対策として従来の裁判所とは別に憲法裁判所を設け、違憲・合憲の判断責任を三権から独立させる。憲法裁判所長官、最高裁長官共に公選にする。
		<br><span class="badge badge-dark">9 likes</span>
	</li>
	<li class="list-group-item">
...
<img src="{{site.baseurl}}/images/war_and_peace2020/edge_bundling_Q2.jpg" alt="WarPeace2020_bipartiteQ2"
style = "
  width: 600px;
  border: none;
  background: none;
...
<!-- ## 分析手法
- Q1 : Markov-chain Monte carlo (nested) in [graph-tool](https://graph-tool.skewed.de/static/doc/inference.html)
- Q2 : Markov-chain Monte carlo (unnested) in [graph-tool](https://graph-tool.skewed.de/static/doc/inference.html) -->
